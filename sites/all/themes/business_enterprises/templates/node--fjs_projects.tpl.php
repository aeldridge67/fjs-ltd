...
<?php endif; ?>
  ...
  <div class="content"<?php print $content_attributes; ?>>
  	...
  	<div class="project_metadata_wrapper">
  		<div id="project_summary"><?php print render($content['body']); ?></div>
  		<table id="project_metadata_table">
	  	<tr><td class="project_metadata_label">PROJECT:</td><td class="project_metadata"><?php print render($content['field_project_type']); ?></td></tr>
